    ...
    <div>
        ...
        <div class="pt-12 flex flex-col gap-20">
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full">
                ...
                <div
                    class="w-full sm:w-1/3 p-4 bg-white border border-gray-200 rounded-2xl h-65 flex flex-col justify-between">
                    <h3 class="text-black font-bold text-[16px] m-0">Detalles de la transferencia</h3>
                    ...
                    <h3 class="text-blue font-normal text-[12px] m-0">mas criterios de busqueda </h3>
                </div>
                <div
                    class="w-full sm:w-1/3 p-4 bg-white border border-gray-200 rounded-2xl h-65 flex flex-col justify-between">
            ...
            <XSnackBar icon="x:info-empty" bg-circle="bg-[#EBF5FB]" closable class="border-[#86C1E9] mb-4"
                class-icon="text-[#5F6A7B] w-[30px] h-[30px]">
                <p class="text-[#5F6A7B]">
